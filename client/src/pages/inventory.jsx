      ...
      <div className="container mx-auto p-4 pt-6 md:p-6 lg:p-12">
        ...
        {loading ? (
          <div className="flex justify-center">
            <div className="spinner-border animate-spin inline-block w-9 h-9 border-7 rounded-full" role="status">
              ...
              {products.map((element, index) => {
                return (
                  <tr key={index}>
                    ...
                    <td>
                      <button
                        className="p-2 rounded bg-pink-600 text-white hover:bg-orange-700"
                        onClick={() => {
                      ...
                      <button
                        className="p-2 rounded bg-pink-600 text-white hover:bg-red-700"
...
<div className="m-5">
          <button className="p-2 rounded bg-pink-600 text-white hover:bg-green-700" onClick={handleShowAddProduct}>
            Add Product
          </button>
        </div>
